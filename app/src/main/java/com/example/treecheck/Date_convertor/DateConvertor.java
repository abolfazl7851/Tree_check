package com.example.treecheck.Date_convertor;
...
public class DateConvertor {
    ...
    public String gmt(String datestr){
        ...
        return String.valueOf(formattedDate+":00");
    }

    public String persian_time(String datestr){
        String dateStr=datestr;
        SimpleDateFormat df = new SimpleDateFormat("HH:mm");
        df.setTimeZone(TimeZone.getTimeZone("UTC"));
        Date date = null;
